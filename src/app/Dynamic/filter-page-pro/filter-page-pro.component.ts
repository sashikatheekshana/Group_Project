...
@Component({
  selector: 'app-filter-page-pro',
  templateUrl: './filter-page-pro.component.html',
  styleUrls: ['./filter-page-pro.component.scss']
})
export class FilterPageProComponent implements OnInit {
